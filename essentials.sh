base="bash-completion dosfstools git man-db nano ntfs-3g pacman-contrib power-profiles-daemon reflector unrar unzip"
...
extra="clang firefox github-cli go gopls libreoffice-fresh pyright qbittorrent ruff steam ttf-jetbrains-mono zed zig zls"
